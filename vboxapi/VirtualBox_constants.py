...
class VirtualBoxReflectionInfo:
    ...
    __dVBoxStatuses = {
        ...
        'VINF_THREAD_IS_TERMINATING': 22424,
        'VERR_THREAD_IS_TERMINATING': -22424,
        'VERR_PROC_NO_ARG_TRANSLATION': -22425,
        'VERR_FLOAT_UNDERFLOW': -22426,
        'VWRN_FLOAT_UNDERFLOW': 22426,
        'VERR_FLOAT_OVERFLOW': -22427,
        'VWRN_FLOAT_OVERFLOW': 22427,
        'VERR_REBOOT_NEEDED': -22428,
        'VINF_REBOOT_NEEDED': 22428,
        'VERR_INSTALLATION_FAILED': -22429,
        'VERR_SYSTEM_INTEGRITY_POLICY_VIOLATION': -22430,
        ...
        'VINF_LOG_DISABLED': 22301,
        'VINF_LOG_NO_LOGGER': 22302,
        ...
        'VERR_CR_PKIX_NOT_ECDSA_PRIVATE_KEY': -23525,
        'VERR_CR_PKIX_NOT_ECDSA_PUBLIC_KEY': -23526,
        'VERR_CR_PKIX_OSSL_D2I_KEY_PARAMS_FAILED': -23527,
        ...
        'VERR_CR_KEY_ALGO_PARAMS_UNEXPECTED': -23816,
        'VERR_CR_KEY_ALGO_PARAMS_MISSING': -23817,
        'VERR_CR_KEY_ALGO_PARAMS_UNKNOWN': -23818,
        'VERR_CR_KEY_ALGO_PARAMS_MISMATCH': -23819,
        ...
        'VERR_CR_OPENSSL_VERSION_TOO_OLD': -24395,
        ...
        'VERR_ISOMK_IMPORT_UDF_DIR_TOO_BIG': -25158,
        'VERR_ISOMK_IMPORT_UDF_DISCONTIGUOUS_ADS': -25159,
        'VERR_ISOMK_IMPORT_UDF_SPARSE_FILE': -25160,
        'VERR_ISOMK_IMPORT_UDF_UNSUPPORTED_FILE_TYPE': -25161,
        'VERR_ISOMK_IMPORT_UDF_FILE_WITH_STREAM_DIR': -25162,
        ...
        'VERR_ISOFS_TOO_BIG_PARTMAP_IN_LVD': -25310,
        ...
        'VERR_ISOFS_BOGUS_NEXT_AD_LENGTH': -25346,
        'VERR_ISOFS_BOGUS_ALLOCATION_EXTENT_LENGTH': -25347,
        'VERR_ISOFS_TOO_MANY_FILE_FRAGMENTS': -25348,
        'VERR_ISOFS_BOGUS_UDF_DSTRING_FIELD': -25349,
        'VERR_ISOFS_BOGUS_UDF_DIR_SIZE': -25350,
        'VERR_ISOFS_NO_ADS_FOR_UDF_DIR': -25351,
        'VERR_ISOFS_NO_ADS_FOR_UDF_OBJECT': -25352,
        ...
        'VERR_CR_CIPHER_INVALID_TAG_LENGTH': -25809,
        'VERR_CR_CIPHER_OSSL_GET_TAG_FAILED': -25810,
        'VERR_CR_CIPHER_OSSL_SET_TAG_FAILED': -25811,
        ...
        'VERR_TRACELOG_READER_MALFORMED_LOG': -26600,
        'VERR_TRACELOG_READER_LOG_UNSUPPORTED': -26601,
        'VERR_TRACELOG_READER_ITERATOR_END': -26602,
        'VERR_HARDAVL_INDEX_OUT_OF_BOUNDS': -26801,
        'VERR_HARDAVL_POINTER_OUT_OF_BOUNDS': -26802,
        'VERR_HARDAVL_MISALIGNED_POINTER': -26803,
        'VERR_HARDAVL_NODE_IS_FREE': -26804,
        'VERR_HARDAVL_STACK_OVERFLOW': -26810,
        'VERR_HARDAVL_INSERT_INVALID_KEY_RANGE': -26811,
        'VERR_HARDAVL_BAD_LEFT_HEIGHT': -26812,
        'VERR_HARDAVL_BAD_RIGHT_HEIGHT': -26813,
        'VERR_HARDAVL_BAD_NEW_HEIGHT': -26814,
        'VERR_HARDAVL_UNEXPECTED_NULL_LEFT': -26815,
        'VERR_HARDAVL_UNEXPECTED_NULL_RIGHT': -26816,
        'VERR_HARDAVL_TRAVERSED_TOO_MANY_NODES': -26817,
        'VERR_HARDAVL_LOOKUP_TOO_DEEP': -26818,
        'VERR_HARDAVL_BAD_HEIGHT': -26819,
        'VERR_HARDAVL_UNBALANCED': -26820,
        'VERR_FDT_DTB_MALFORMED': -27000,
        'VERR_FDT_DTB_HDR_MAGIC_INVALID': -27001,
        'VERR_FDT_DTB_HDR_VERSION_NOT_SUPPORTED': -27002,
        'VERR_FDT_DTB_HDR_LAST_COMPAT_VERSION_INVALID': -27003,
        'VERR_FDT_DTB_HDR_SIZE_INVALID': -27004,
        'VERR_FDT_DTB_HDR_MEM_RSV_BLOCK_OFF_INVALID': -27005,
        'VERR_FDT_DTB_HDR_STRUCT_BLOCK_OFF_INVALID': -27006,
        'VERR_FDT_DTB_HDR_STRINGS_BLOCK_OFF_INVALID': -27007,
        'VERR_FDT_DTB_MEM_RSV_BLOCK_TERMINATOR_MISSING': -27008,
        'VERR_FDT_DTB_STRINGS_BLOCK_NOT_TERMINATED': -27009,
        'VERR_FDT_DTB_STRUCTS_BLOCK_TOKEN_INVALID': -27010,
        'VERR_FDT_DTB_STRUCTS_BLOCK_NODE_NAME_INVALID': -27011,
        'VERR_FDT_DTB_STRUCTS_BLOCK_STRING_NOT_TERMINATED': -27012,
        'VERR_FDT_DTB_STRUCTS_BLOCK_MALFORMED_PADDING': -27013,
        'VERR_FDT_DTB_STRUCTS_BLOCK_PREMATURE_END': -27014,
        'VERR_FDT_DTB_PROP_NAME_OFF_TOO_LARGE': -27015,
        'VERR_FDT_DTB_PROP_SIZE_MALFORMED': -27016,
        'VERR_FDT_DTB_PROP_STRING_NOT_TERMINATED': -27017,
        'VERR_FDT_AT_ROOT_LEVEL': -27018,
        'VERR_NO_VM_MEMORY': -1000,
        'VERR_DONT_PANIC': -1001,
        'VERR_UNSUPPORTED_CPU': -1002,
        'VWRN_UNSUPPORTED_CPU': 1002,
        ...
        'VERR_RESERVED_PAGE_TABLE_BITS': -1027,
        'VINF_EM_FIRST': 1100,
        ...
        'VINF_EM_RESCHEDULE_EXEC_ENGINE': 1116,
        ...
        'VINF_EM_EMULATE_SPLIT_LOCK': 1162,
        ...
        'VERR_DBGF_TRACER_IPE_1': -1221,
        'VWRN_DBGF_ALREADY_RUNNING': -1222,
        'VERR_DBGF_IPE_1': -1223,
        'VINF_DBGF_BP_HALT': 1224,
        'VERR_DBGF_OWNER_BUSY': -1225,
        'VERR_DBGF_BP_INT3_ADD_TRIES_REACHED': -1226,
        'VERR_DBGF_BP_IPE_1': -1227,
        'VERR_DBGF_BP_IPE_2': -1228,
        'VERR_DBGF_BP_IPE_3': -1229,
        'VERR_DBGF_BP_IPE_4': -1230,
        'VERR_DBGF_BP_IPE_5': -1231,
        'VERR_DBGF_BP_IPE_6': -1232,
        'VERR_DBGF_BP_IPE_7': -1233,
        'VERR_DBGF_BP_IPE_8': -1234,
        'VERR_DBGF_BP_IPE_9': -1235,
        'VERR_DBGF_BP_L1_LOOKUP_FAILED': -1236,
        'VERR_DBGF_BP_L2_LOOKUP_FAILED': -1237,
        'VERR_DBGF_BP_OWNER_NO_MORE_HANDLES': -1238,
        'VINF_DBGF_R3_BP_OWNER_DEFER': 1239,
        'VERR_DBGF_BP_OWNER_CALLBACK_WRONG_STATUS': -1240,
        'VERR_DBGF_CANCELLED': -1241,
        ...
        'VERR_PGM_PAE_PDPE_RSVD': -1688,
        'VERR_PGM_NOT_SUPPORTED_FOR_NEM_MODE': -1689,
        'VERR_PGM_TOO_MANY_RAM_RANGES': -1690,
        'VERR_PGM_PHYS_RAM_LOOKUP_IPE': -1691,
        'VERR_PGM_TOO_MANY_ROM_RANGES': -1692,
        ...
        'VINF_CPUM_MATCHED_BY_NAME': 1769,
        'VERR_CPUM_UNSUPPORTED_ID_REGISTER': -1770,
        'VERR_CPUM_UNSUPPORTED_ID_REG_VALUE': -1771,
        ...
        'VERR_SSM_ENUM_VALUE_OUT_OF_RANGE': -1880,
        ...
        'VERR_TM_TOO_MANY_TIMERS': -2212,
        'VERR_TM_INVALID_TIMER_QUEUE': -2213,
        'VERR_TM_TIMER_QUEUE_CANNOT_GROW': -2214,
        'VERR_TM_IPE_1': -2291,
        'VERR_TM_IPE_2': -2292,
        'VERR_TM_IPE_3': -2293,
        'VERR_TM_IPE_4': -2294,
        ...
        'VERR_TRPM_BAD_TRAP_IN_OP': -2405,
        'VERR_TRPM_IPE_1': -2406,
        'VERR_TRPM_IPE_2': -2407,
        'VERR_TRPM_IPE_3': -2408,
        'VERR_TRPM_HM_IPE': -2409,
        ...
        'VERR_VMM_CONTEXT_HOOK_STILL_ENABLED': -2719,
        'VERR_VMM_CANNOT_BLOCK': -2720,
        'VERR_VMM_FN_NOT_SUPPORTED_FOR_VMTARGET': -2721,
        ...
        'VERR_PDM_CRITSECT_ABORT_FAILED': -7201,
        'VERR_PDM_CRITSECTRW_TOO_MANY_READERS': -7202,
        'VERR_PDM_CRITSECTRW_TOO_MANY_WRITERS': -7203,
        'VERR_PDM_CRITSECTRW_TOO_MANY_RECURSIONS': -7204,
        'VERR_PDM_CRITSECTRW_IPE': -7205,
        'VERR_PDM_CRITSECTRW_MISALIGNED': -7206,
        ...
        'VERR_HGCM_TOO_MANY_CLIENTS': -2908,
        'VERR_HGCM_TOO_MANY_CLIENT_CALLS': -2909,
        ...
        'VERR_SUPDRV_TOKEN_VIRTUALIZATION_ALLOWED_ZEROING': -7001,
        'VERR_SUPDRV_TOKEN_VIRTUALIZATION_ENABLED_ZEROING': -7002,
        'VERR_SUPDRV_REF_PRIMARY_PROCESS_TOKEN_FAILED': -7003,
        'VERR_SUPDRV_OPEN_PRIMARY_PROCESS_TOKEN_FAILED': -7004,
        'VERR_SUPDRV_TOKEN_ADJ_THREAD_CREATE_FAILED': -7005,
        'VERR_SUPDRV_TOKEN_ADJ_THREAD_WAIT_ERROR': -7006,
        'VERR_SUPDRV_TOKEN_VIRTUALIZATION_STILL_ALLOWED': -7007,
        'VERR_SUPDRV_TOKEN_VIRTUALIZATION_STILL_ENABLED': -7008,
        ...
        'VERR_SUPLIB_RWXPG_CORRUPTED': -3779,
        ...
        'VERR_GVM_MISMATCH_VM_SIZE': -3904,
        'VERR_GVM_MISMATCH_VMCPU_SIZE': -3905,
        'VERR_GVM_MISMATCH_VM_STRUCT_VER': -3906,
        'VERR_GVM_MISMATCH_SVN_REV': -3907,
        ...
        'VERR_VMX_STARTVM_PRECOND_0': -4039,
        'VERR_VMX_STARTVM_PRECOND_1': -4040,
        'VERR_VMX_STARTVM_PRECOND_2': -4041,
        'VERR_VMX_STARTVM_PRECOND_3': -4042,
        ...
        'VERR_SVM_VMRUN_PRECOND_0': -4070,
        'VERR_SVM_VMRUN_PRECOND_1': -4071,
        'VERR_SVM_VMRUN_PRECOND_2': -4072,
        'VERR_SVM_VMRUN_PRECOND_3': -4073,
        'VERR_SVM_HOST_SVME_NOT_ENABLED': -4074,
        'VERR_SVM_HOST_VM_HSAVE_PA_INVALID': -4075,
        ...
        'VERR_GVMM_VM_STRUCT_NOT_PAGE_ALIGNED': -5206,
        'VERR_GVMM_VMCPU_STRUCT_NOT_PAGE_ALIGNED': -5207,
        'VERR_GVMM_GVM_STRUCT_NOT_PAGE_ALIGNED': -5208,
        'VERR_GVMM_GVMCPU_STRUCT_NOT_PAGE_ALIGNED': -5209,
        ...
        'VINF_IEM_YIELD_PENDING_FF': 5306,
        'VINF_IEM_REEXEC_BREAK': 5310,
        'VINF_IEM_REEXEC_BREAK_FF': 5311,
        'VINF_IEM_REEXEC_FINISH_WITH_FLAGS': 5312,
        'VINF_IEM_REEXEC_JUMP': 5313,
        'VINF_IEM_RECOMPILE_END_TB': 5319,
        'VERR_IEM_TB_ALLOC_FAILED': -5320,
        'VERR_IEM_COND_TOO_DEEPLY_NESTED': -5321,
        'VERR_IEM_COND_ENDIF_RECONCILIATION_FAILED': -5322,
        'VERR_IEM_DBGINFO_OUT_OF_MEMORY': -5323,
        'VERR_IEM_DBGINFO_IPE_1': -5324,
        'VERR_IEM_DBGINFO_IPE_2': -5325,
        'VERR_IEM_FIXUP_IPE_1': -5326,
        'VERR_IEM_FIXUP_TOO_MANY': -5327,
        'VERR_IEM_FIXUP_OUT_OF_MEMORY': -5328,
        'VERR_IEM_FIXUP_SHORT_JMP_TO_TAIL_LABEL': -5329,
        'VERR_IEM_INSTR_BUF_TOO_LARGE': -5330,
        'VERR_IEM_INSTR_BUF_OUT_OF_MEMORY': -5331,
        'VERR_IEM_LABEL_TOO_MANY': -5332,
        'VERR_IEM_LABEL_OUT_OF_MEMORY': -5333,
        'VERR_IEM_LABEL_IPE_1': -5334,
        'VERR_IEM_LABEL_IPE_2': -5335,
        'VERR_IEM_LABEL_IPE_3': -5336,
        'VERR_IEM_LABEL_IPE_4': -5337,
        'VERR_IEM_LABEL_IPE_5': -5338,
        'VERR_IEM_LABEL_IPE_6': -5339,
        'VERR_IEM_REG_ALLOCATOR_NO_FREE_TMP': -5340,
        'VERR_IEM_REG_ALLOCATOR_NO_FREE_VAR': -5341,
        'VERR_IEM_REG_IPE_1': -5343,
        'VERR_IEM_REG_IPE_2': -5344,
        'VERR_IEM_REG_IPE_3': -5345,
        'VERR_IEM_REG_IPE_4': -5346,
        'VERR_IEM_REG_IPE_5': -5347,
        'VERR_IEM_REG_IPE_6': -5348,
        'VERR_IEM_REG_IPE_7': -5349,
        'VERR_IEM_REG_IPE_8': -5350,
        'VERR_IEM_REG_IPE_9': -5351,
        'VERR_IEM_REG_IPE_10': -5352,
        'VERR_IEM_REG_IPE_11': -5353,
        'VERR_IEM_REG_IPE_12': -5354,
        'VERR_IEM_REG_IPE_13': -5355,
        'VERR_IEM_VAR_EXHAUSTED': -5360,
        'VERR_IEM_VAR_DUP_ARG_NO': -5361,
        'VERR_IEM_VAR_OUT_OF_STACK_SLOTS': -5362,
        'VERR_IEM_VAR_UNEXPECTED_KIND': -5363,
        'VERR_IEM_VAR_NOT_INITIALIZED': -5364,
        'VERR_IEM_VAR_IPE_1': -5365,
        'VERR_IEM_VAR_IPE_2': -5366,
        'VERR_IEM_VAR_IPE_3': -5367,
        'VERR_IEM_VAR_IPE_4': -5368,
        'VERR_IEM_VAR_IPE_5': -5369,
        'VERR_IEM_VAR_IPE_6': -5370,
        'VERR_IEM_VAR_IPE_7': -5371,
        'VERR_IEM_VAR_IPE_8': -5372,
        'VERR_IEM_VAR_IPE_9': -5373,
        'VERR_IEM_VAR_IPE_10': -5374,
        'VERR_IEM_VAR_IPE_11': -5375,
        'VERR_IEM_VAR_IPE_12': -5376,
        'VERR_IEM_VAR_IPE_13': -5377,
        'VERR_IEM_EMIT_CASE_NOT_IMPLEMENTED_1': -5380,
        'VERR_IEM_EMIT_BAD_MEM_SIZE': -5381,
        'VERR_IEM_EMIT_BAD_SEG_REG_NO': -5382,
        'VERR_IEM_EMIT_FIXED_JUMP_OUT_OF_RANGE': -5383,
        'VERR_IEM_EMIT_UNEXPECTED_VAR_REGISTER': -5384,
        ...
        'VERR_SUP_VP_PARENT_NOT_FOUND': -5669,
        'VERR_SUP_VP_PARENT_OPEN_ERROR': -5670,
        'VERR_SUP_VP_PARENT_THREAD_NOT_FOUND': -5671,
        'VERR_SUP_VP_PARENT_THREAD_OPEN_ERROR': -5672,
        ...
        'VERR_SUP_VP_QUERY_HANDLE_TYPE': -5677,
        'VERR_SUP_VP_SET_HANDLE_NOINHERIT': -5678,
        'VERR_SUP_VP_NOT_SIGNED_WITH_SPECIALLY_TRUSTED_CERT': -5679,
        'VERR_SUP_VP_EXE_MALFORMED_RWX_SECTION': -5680,
        'VERR_SUP_VP_EXE_CORRUPTED_RWX_SECTION': -5681,
        'VERR_SUP_DRIVERLESS': -5699,
        'VINF_SUP_DRIVERLESS': 5699,
        ...
        'VERR_AUDIO_ENUMERATION_FAILED': -6607,
        'VERR_AUDIO_STREAM_INIT_IN_PROGRESS': -6608,
        'VINF_AUDIO_STREAM_ASYNC_INIT_NEEDED': 6609,
        'VERR_APIC_INTR_NOT_PENDING': -6700,
        'VERR_APIC_INTR_MASKED_BY_TPR': -6701,
        'VERR_APIC_INTR_DISCARDED': -6702,
        'VERR_APIC_INIT_FAILED': -6703,
        'VERR_APIC_WRITE_INVALID': -6704,
        'VERR_APIC_IPE_0': -6705,
        'VERR_APIC_IPE_1': -6706,
        'VERR_APIC_IPE_2': -6707,
        ...
        'VERR_NEM_QUERY_DIRTY_BITMAP_FAILED': -6816,
        'VERR_NEM_MISSING_FEATURE': -6817,
        'VERR_NEM_IPE_0': -6890,
        'VERR_NEM_IPE_1': -6891,
        'VERR_NEM_IPE_2': -6892,
        'VERR_NEM_IPE_3': -6893,
        ...
        'VERR_RECORDING_INIT_FAILED': -6901,
        ...
        'VERR_RECORDING_ENCODING_FAILED': -6908,
        'VWRN_RECORDING_ENCODING_SKIPPED': 6908,
        ...
        'VERR_SHCLPB_EVENT_ID_NOT_FOUND': -7105,
        'VERR_SHCLPB_MAX_EVENTS_REACHED': -7106,
        'VERR_SHCLPB_TRANSFER_ID_NOT_FOUND': -7150,
        'VERR_SHCLPB_GUEST_ERROR': -7151,
        'VERR_SHCLPB_EVENT_FAILED': -7152,
        'VERR_SHCLPB_NO_DATA': -7153,
        'VERR_IOMMU_DTE_READ_FAILED': -7300,
        'VERR_IOMMU_DTE_BAD_OFFSET': -7301,
        'VERR_IOMMU_ADDR_TRANSLATION_FAILED': -7302,
        'VERR_IOMMU_ADDR_ACCESS_DENIED': -7303,
        'VERR_IOMMU_INTR_REMAP_FAILED': -7304,
        'VERR_IOMMU_INTR_REMAP_DENIED': -7305,
        'VERR_IOMMU_CMD_NOT_SUPPORTED': -7306,
        'VERR_IOMMU_CMD_INVALID_FORMAT': -7307,
        'VERR_IOMMU_CMD_HW_ERROR': -7308,
        'VERR_IOMMU_NOT_PRESENT': -7309,
        'VERR_IOMMU_CANNOT_CALL_SELF': -7310,
        'VINF_IOMMU_ADDR_TRANSLATION_DISABLED': 7311,
        'VERR_IOMMU_IPE_0': -7390,
        'VERR_IOMMU_IPE_1': -7391,
        'VERR_IOMMU_IPE_2': -7392,
        'VERR_IOMMU_IPE_3': -7393,
        'VERR_IOMMU_IPE_4': -7394,
        'VERR_IOMMU_IPE_5': -7395,
        'VERR_IOMMU_IPE_6': -7396,
        'VERR_IOMMU_IPE_7': -7397,
        'VERR_IOMMU_IPE_8': -7398,
        'VERR_IOMMU_IPE_9': -7399,
        'VERR_PLATFORM_ARCH_NOT_SUPPORTED': -7400,
        'VINF_GCM_HANDLED': 7600,
        'VINF_GCM_HANDLED_ADVANCE_RIP': 7601,
        'VERR_GCM_NOT_HANDLED': -7602,
        'VERR_DRIVER_REBOOT_NEEDED': -1028,
        'VINF_DRIVER_REBOOT_NEEDED': 1028,
    ...
    __dValues = {
        ...
        'VBoxEventType': {
            ...
            'OnGuestDirectoryRegistered': 119,
            'OnGuestDirectoryStateChanged': 120,
            'OnGuestDirectoryRead': 121,
            'OnClipboardError': 122,
            'OnExtPackInstalled': 123,
            'OnExtPackUninstalled': 124,
            'OnRecordingScreenStateChanged': 125,
            'End': 126,
        },
        'GuestMouseEventMode': {
            'Relative': 0,
    ...
    __dValuesSym = {
        ...
        'VBoxEventType': {
            ...
            'OnRecordingScreenStateChanged': 'OnRecordingScreenStateChanged',
            'End': 'End',
        },
        'GuestMouseEventMode': {
            'Relative': 'Relative',
        ...
        'SymlinkPolicy': {
            'None': 'None',
            'Forbidden': 'Forbidden',
            'AllowedInShareSubtree': 'AllowedInShareSubtree',
            'AllowedToRelativeTargets': 'AllowedToRelativeTargets',
            'AllowedToAnyTarget': 'AllowedToAnyTarget',
        },
    }
    ...
    __dValuesFlat = dict({
        ...
        'VBOX_E_RECORDING_ERROR': 0x80BB0013,
    }, **__dVBoxStatuses)
    ...
    __dValuesFlatSym = {
        ...
        'SettingsVersion_v1_19': 'v1_19',
        'SettingsVersion_v1_20': 'v1_20',
        'SettingsVersion_v1_21': 'v1_21',
        ...
        'PlatformArchitecture_None': 'None',
        'PlatformArchitecture_x86': 'x86',
        'PlatformArchitecture_ARM': 'ARM',
        'CPUArchitecture_Any': 'Any',
        'CPUArchitecture_x86': 'x86',
        'CPUArchitecture_AMD64': 'AMD64',
        'CPUArchitecture_ARMv8_32': 'ARMv8_32',
        'CPUArchitecture_ARMv8_64': 'ARMv8_64',
        'CPUPropertyTypeX86_Null': 'Null',
        'CPUPropertyTypeX86_PAE': 'PAE',
        'CPUPropertyTypeX86_LongMode': 'LongMode',
        'CPUPropertyTypeX86_TripleFaultReset': 'TripleFaultReset',
        'CPUPropertyTypeX86_APIC': 'APIC',
        'CPUPropertyTypeX86_X2APIC': 'X2APIC',
        'CPUPropertyTypeX86_IBPBOnVMExit': 'IBPBOnVMExit',
        'CPUPropertyTypeX86_IBPBOnVMEntry': 'IBPBOnVMEntry',
        'CPUPropertyTypeX86_HWVirt': 'HWVirt',
        'CPUPropertyTypeX86_SpecCtrl': 'SpecCtrl',
        'CPUPropertyTypeX86_SpecCtrlByHost': 'SpecCtrlByHost',
        'CPUPropertyTypeX86_L1DFlushOnEMTScheduling': 'L1DFlushOnEMTScheduling',
        'CPUPropertyTypeX86_L1DFlushOnVMEntry': 'L1DFlushOnVMEntry',
        'CPUPropertyTypeX86_MDSClearOnEMTScheduling': 'MDSClearOnEMTScheduling',
        'CPUPropertyTypeX86_MDSClearOnVMEntry': 'MDSClearOnVMEntry',
        'CPUPropertyTypeARM_Null': 'Null',
        'CPUPropertyTypeARM_HWVirt': 'HWVirt',
        'CPUPropertyTypeARM_GICITS': 'GICITS',
        ...
        'HWVirtExPropertyType_VirtVmsaveVmload': 'VirtVmsaveVmload',
        ...
        'FirmwareBootMenuMode_Disabled': 'Disabled',
        'FirmwareBootMenuMode_MenuOnly': 'MenuOnly',
        'FirmwareBootMenuMode_MessageAndMenu': 'MessageAndMenu',
        ...
        'ProcessorFeature_VirtVmsaveVmload': 'VirtVmsaveVmload',
        ...
        'PointingHIDType_USBMultiTouchScreenPlusPad': 'USBMultiTouchScreenPlusPad',
        ...
        'PartitioningType_MBR': 'MBR',
        'PartitioningType_GPT': 'GPT',
        'PartitionType_Empty': 'Empty',
        'PartitionType_FAT12': 'FAT12',
        'PartitionType_FAT16': 'FAT16',
        'PartitionType_FAT': 'FAT',
        'PartitionType_IFS': 'IFS',
        'PartitionType_FAT32CHS': 'FAT32CHS',
        'PartitionType_FAT32LBA': 'FAT32LBA',
        'PartitionType_FAT16B': 'FAT16B',
        'PartitionType_Extended': 'Extended',
        'PartitionType_WindowsRE': 'WindowsRE',
        'PartitionType_LinuxSwapOld': 'LinuxSwapOld',
        'PartitionType_LinuxOld': 'LinuxOld',
        'PartitionType_DragonFlyBSDSlice': 'DragonFlyBSDSlice',
        'PartitionType_LinuxSwap': 'LinuxSwap',
        'PartitionType_Linux': 'Linux',
        'PartitionType_LinuxExtended': 'LinuxExtended',
        'PartitionType_LinuxLVM': 'LinuxLVM',
        'PartitionType_BSDSlice': 'BSDSlice',
        'PartitionType_AppleUFS': 'AppleUFS',
        'PartitionType_AppleHFS': 'AppleHFS',
        'PartitionType_Solaris': 'Solaris',
        'PartitionType_GPT': 'GPT',
        'PartitionType_EFI': 'EFI',
        'PartitionType_Unknown': 'Unknown',
        'PartitionType_MBR': 'MBR',
        'PartitionType_iFFS': 'iFFS',
        'PartitionType_SonyBoot': 'SonyBoot',
        'PartitionType_LenovoBoot': 'LenovoBoot',
        'PartitionType_WindowsMSR': 'WindowsMSR',
        'PartitionType_WindowsBasicData': 'WindowsBasicData',
        'PartitionType_WindowsLDMMeta': 'WindowsLDMMeta',
        'PartitionType_WindowsLDMData': 'WindowsLDMData',
        'PartitionType_WindowsRecovery': 'WindowsRecovery',
        'PartitionType_WindowsStorageSpaces': 'WindowsStorageSpaces',
        'PartitionType_WindowsStorageReplica': 'WindowsStorageReplica',
        'PartitionType_IBMGPFS': 'IBMGPFS',
        'PartitionType_LinuxData': 'LinuxData',
        'PartitionType_LinuxRAID': 'LinuxRAID',
        'PartitionType_LinuxRootX86': 'LinuxRootX86',
        'PartitionType_LinuxRootAMD64': 'LinuxRootAMD64',
        'PartitionType_LinuxRootARM32': 'LinuxRootARM32',
        'PartitionType_LinuxRootARM64': 'LinuxRootARM64',
        'PartitionType_LinuxHome': 'LinuxHome',
        'PartitionType_LinuxSrv': 'LinuxSrv',
        'PartitionType_LinuxPlainDmCrypt': 'LinuxPlainDmCrypt',
        'PartitionType_LinuxLUKS': 'LinuxLUKS',
        'PartitionType_LinuxReserved': 'LinuxReserved',
        'PartitionType_FreeBSDBoot': 'FreeBSDBoot',
        'PartitionType_FreeBSDData': 'FreeBSDData',
        'PartitionType_FreeBSDSwap': 'FreeBSDSwap',
        'PartitionType_FreeBSDUFS': 'FreeBSDUFS',
        'PartitionType_FreeBSDVinum': 'FreeBSDVinum',
        'PartitionType_FreeBSDZFS': 'FreeBSDZFS',
        'PartitionType_FreeBSDUnknown': 'FreeBSDUnknown',
        'PartitionType_AppleHFSPlus': 'AppleHFSPlus',
        'PartitionType_AppleAPFS': 'AppleAPFS',
        'PartitionType_AppleRAID': 'AppleRAID',
        'PartitionType_AppleRAIDOffline': 'AppleRAIDOffline',
        'PartitionType_AppleBoot': 'AppleBoot',
        'PartitionType_AppleLabel': 'AppleLabel',
        'PartitionType_AppleTvRecovery': 'AppleTvRecovery',
        'PartitionType_AppleCoreStorage': 'AppleCoreStorage',
        'PartitionType_SoftRAIDStatus': 'SoftRAIDStatus',
        'PartitionType_SoftRAIDScratch': 'SoftRAIDScratch',
        'PartitionType_SoftRAIDVolume': 'SoftRAIDVolume',
        'PartitionType_SoftRAIDCache': 'SoftRAIDCache',
        'PartitionType_AppleUnknown': 'AppleUnknown',
        'PartitionType_SolarisBoot': 'SolarisBoot',
        'PartitionType_SolarisRoot': 'SolarisRoot',
        'PartitionType_SolarisSwap': 'SolarisSwap',
        'PartitionType_SolarisBackup': 'SolarisBackup',
        'PartitionType_SolarisUsr': 'SolarisUsr',
        'PartitionType_SolarisVar': 'SolarisVar',
        'PartitionType_SolarisHome': 'SolarisHome',
        'PartitionType_SolarisAltSector': 'SolarisAltSector',
        'PartitionType_SolarisReserved': 'SolarisReserved',
        'PartitionType_SolarisUnknown': 'SolarisUnknown',
        'PartitionType_NetBSDSwap': 'NetBSDSwap',
        'PartitionType_NetBSDFFS': 'NetBSDFFS',
        'PartitionType_NetBSDLFS': 'NetBSDLFS',
        'PartitionType_NetBSDRAID': 'NetBSDRAID',
        'PartitionType_NetBSDConcatenated': 'NetBSDConcatenated',
        'PartitionType_NetBSDEncrypted': 'NetBSDEncrypted',
        'PartitionType_NetBSDUnknown': 'NetBSDUnknown',
        'PartitionType_ChromeOSKernel': 'ChromeOSKernel',
        'PartitionType_ChromeOSRootFS': 'ChromeOSRootFS',
        'PartitionType_ChromeOSFuture': 'ChromeOSFuture',
        'PartitionType_ContLnxUsr': 'ContLnxUsr',
        'PartitionType_ContLnxRoot': 'ContLnxRoot',
        'PartitionType_ContLnxReserved': 'ContLnxReserved',
        'PartitionType_ContLnxRootRAID': 'ContLnxRootRAID',
        'PartitionType_HaikuBFS': 'HaikuBFS',
        'PartitionType_MidntBSDBoot': 'MidntBSDBoot',
        'PartitionType_MidntBSDData': 'MidntBSDData',
        'PartitionType_MidntBSDSwap': 'MidntBSDSwap',
        'PartitionType_MidntBSDUFS': 'MidntBSDUFS',
        'PartitionType_MidntBSDVium': 'MidntBSDVium',
        'PartitionType_MidntBSDZFS': 'MidntBSDZFS',
        'PartitionType_MidntBSDUnknown': 'MidntBSDUnknown',
        'PartitionType_OpenBSDData': 'OpenBSDData',
        'PartitionType_QNXPowerSafeFS': 'QNXPowerSafeFS',
        'PartitionType_Plan9': 'Plan9',
        'PartitionType_VMWareVMKCore': 'VMWareVMKCore',
        'PartitionType_VMWareVMFS': 'VMWareVMFS',
        'PartitionType_VMWareReserved': 'VMWareReserved',
        'PartitionType_VMWareUnknown': 'VMWareUnknown',
        'PartitionType_AndroidX86Bootloader': 'AndroidX86Bootloader',
        'PartitionType_AndroidX86Bootloader2': 'AndroidX86Bootloader2',
        'PartitionType_AndroidX86Boot': 'AndroidX86Boot',
        'PartitionType_AndroidX86Recovery': 'AndroidX86Recovery',
        'PartitionType_AndroidX86Misc': 'AndroidX86Misc',
        'PartitionType_AndroidX86Metadata': 'AndroidX86Metadata',
        'PartitionType_AndroidX86System': 'AndroidX86System',
        'PartitionType_AndroidX86Cache': 'AndroidX86Cache',
        'PartitionType_AndroidX86Data': 'AndroidX86Data',
        'PartitionType_AndroidX86Persistent': 'AndroidX86Persistent',
        'PartitionType_AndroidX86Vendor': 'AndroidX86Vendor',
        'PartitionType_AndroidX86Config': 'AndroidX86Config',
        'PartitionType_AndroidX86Factory': 'AndroidX86Factory',
        'PartitionType_AndroidX86FactoryAlt': 'AndroidX86FactoryAlt',
        'PartitionType_AndroidX86Fastboot': 'AndroidX86Fastboot',
        'PartitionType_AndroidX86OEM': 'AndroidX86OEM',
        'PartitionType_AndroidARMMeta': 'AndroidARMMeta',
        'PartitionType_AndroidARMExt': 'AndroidARMExt',
        'PartitionType_ONIEBoot': 'ONIEBoot',
        'PartitionType_ONIEConfig': 'ONIEConfig',
        'PartitionType_PowerPCPrep': 'PowerPCPrep',
        'PartitionType_XDGShrBootConfig': 'XDGShrBootConfig',
        'PartitionType_CephBlock': 'CephBlock',
        'PartitionType_CephBlockDB': 'CephBlockDB',
        'PartitionType_CephBlockDBDmc': 'CephBlockDBDmc',
        'PartitionType_CephBlockDBDmcLUKS': 'CephBlockDBDmcLUKS',
        'PartitionType_CephBlockDmc': 'CephBlockDmc',
        'PartitionType_CephBlockDmcLUKS': 'CephBlockDmcLUKS',
        'PartitionType_CephBlockWALog': 'CephBlockWALog',
        'PartitionType_CephBlockWALogDmc': 'CephBlockWALogDmc',
        'PartitionType_CephBlockWALogDmcLUKS': 'CephBlockWALogDmcLUKS',
        'PartitionType_CephDisk': 'CephDisk',
        'PartitionType_CephDiskDmc': 'CephDiskDmc',
        'PartitionType_CephJournal': 'CephJournal',
        'PartitionType_CephJournalDmc': 'CephJournalDmc',
        'PartitionType_CephJournalDmcLUKS': 'CephJournalDmcLUKS',
        'PartitionType_CephLockbox': 'CephLockbox',
        'PartitionType_CephMultipathBlock1': 'CephMultipathBlock1',
        'PartitionType_CephMultipathBlock2': 'CephMultipathBlock2',
        'PartitionType_CephMultipathBlockDB': 'CephMultipathBlockDB',
        'PartitionType_CephMultipathBLockWALog': 'CephMultipathBLockWALog',
        'PartitionType_CephMultipathJournal': 'CephMultipathJournal',
        'PartitionType_CephMultipathOSD': 'CephMultipathOSD',
        'PartitionType_CephOSD': 'CephOSD',
        'PartitionType_CephOSDDmc': 'CephOSDDmc',
        'PartitionType_CephOSDDmcLUKS': 'CephOSDDmcLUKS',
        'TrackedObjectState_None': 'None',
        'TrackedObjectState_Alive': 'Alive',
        'TrackedObjectState_Deleted': 'Deleted',
        'TrackedObjectState_Invalid': 'Invalid',
        ...
        'ImportOptions_KeepExtraData': 'KeepExtraData',
        ...
        'VirtualSystemDescriptionType_CloudCompartmentId': 'CloudCompartmentId',
        'VirtualSystemDescriptionType_CloudShapeCpus': 'CloudShapeCpus',
        'VirtualSystemDescriptionType_CloudShapeMemory': 'CloudShapeMemory',
        'VirtualSystemDescriptionType_CloudInstanceMetadata': 'CloudInstanceMetadata',
        ...
        'RecordingAudioCodec_MP3': 'MP3',
        'RecordingAudioCodec_OggVorbis': 'OggVorbis',
        'RecordingAudioCodec_Opus': 'Opus',
        'RecordingAudioCodec_Other': 'Other',
        'RecordingCodecDeadline_Default': 'Default',
        'RecordingCodecDeadline_Realtime': 'Realtime',
        'RecordingCodecDeadline_Good': 'Good',
        'RecordingCodecDeadline_Best': 'Best',
        'RecordingVideoCodec_None': 'None',
        'RecordingVideoCodec_MJPEG': 'MJPEG',
        'RecordingVideoCodec_H262': 'H262',
        'RecordingVideoCodec_H264': 'H264',
        'RecordingVideoCodec_H265': 'H265',
        'RecordingVideoCodec_H266': 'H266',
        'RecordingVideoCodec_VP8': 'VP8',
        'RecordingVideoCodec_VP9': 'VP9',
        'RecordingVideoCodec_AV1': 'AV1',
        'RecordingVideoCodec_Other': 'Other',
        'RecordingVideoScalingMode_None': 'None',
        'RecordingVideoScalingMode_NearestNeighbor': 'NearestNeighbor',
        'RecordingVideoScalingMode_Bilinear': 'Bilinear',
        'RecordingVideoScalingMode_Bicubic': 'Bicubic',
        'RecordingRateControlMode_ABR': 'ABR',
        'RecordingRateControlMode_CBR': 'CBR',
        'RecordingRateControlMode_VBR': 'VBR',
        'RecordingState_Unknown': 'Unknown',
        'RecordingState_Initializing': 'Initializing',
        'RecordingState_Started': 'Started',
        'RecordingState_Paused': 'Paused',
        'RecordingState_Resumed': 'Resumed',
        'RecordingState_Finalizing': 'Finalizing',
        'RecordingState_Stopped': 'Stopped',
        'RecordingState_Canceled': 'Canceled',
        'RecordingState_LimitReached': 'LimitReached',
        'RecordingState_Error': 'Error',
        'SignatureType_X509': 'X509',
        'SignatureType_Sha256': 'Sha256',
        'UefiVariableAttributes_None': 'None',
        'UefiVariableAttributes_NonVolatile': 'NonVolatile',
        'UefiVariableAttributes_BootServiceAccess': 'BootServiceAccess',
        'UefiVariableAttributes_RuntimeAccess': 'RuntimeAccess',
        'UefiVariableAttributes_HwErrorRecord': 'HwErrorRecord',
        'UefiVariableAttributes_AuthWriteAccess': 'AuthWriteAccess',
        'UefiVariableAttributes_AuthTimeBasedWriteAccess': 'AuthTimeBasedWriteAccess',
        'UefiVariableAttributes_AuthAppendWrite': 'AuthAppendWrite',
        ...
        'GraphicsControllerType_QemuRamFB': 'QemuRamFB',
        'GraphicsFeature_None': 'None',
        'GraphicsFeature_Acceleration3D': 'Acceleration3D',
        ...
        'IommuType_None': 'None',
        'IommuType_Automatic': 'Automatic',
        'IommuType_AMD': 'AMD',
        'IommuType_Intel': 'Intel',
        'VMExecutionEngine_NotSet': 'NotSet',
        'VMExecutionEngine_Default': 'Default',
        'VMExecutionEngine_HwVirt': 'HwVirt',
        'VMExecutionEngine_NativeApi': 'NativeApi',
        'VMExecutionEngine_Interpreter': 'Interpreter',
        'VMExecutionEngine_Recompiler': 'Recompiler',
        ...
        'HostNetworkInterfaceType_Invalid': 'Invalid',
        'HostNetworkInterfaceType_Bridged': 'Bridged',
        'HostNetworkInterfaceType_HostOnly': 'HostOnly',
        'UpdateChannel_Invalid': 'Invalid',
        'UpdateChannel_Stable': 'Stable',
        'UpdateChannel_All': 'All',
        'UpdateChannel_WithBetas': 'WithBetas',
        'UpdateChannel_WithTesting': 'WithTesting',
        'UpdateSeverity_Invalid': 'Invalid',
        'UpdateSeverity_Critical': 'Critical',
        'UpdateSeverity_Major': 'Major',
        'UpdateSeverity_Minor': 'Minor',
        'UpdateSeverity_Testing': 'Testing',
        'UpdateState_Invalid': 'Invalid',
        'UpdateState_Available': 'Available',
        'UpdateState_NotAvailable': 'NotAvailable',
        'UpdateState_Downloading': 'Downloading',
        'UpdateState_Downloaded': 'Downloaded',
        'UpdateState_Installing': 'Installing',
        'UpdateState_Installed': 'Installed',
        'UpdateState_UserInteraction': 'UserInteraction',
        'UpdateState_Canceled': 'Canceled',
        'UpdateState_Maintenance': 'Maintenance',
        'UpdateState_Error': 'Error',
        ...
        'GuestShutdownFlag_None': 'None',
        'GuestShutdownFlag_PowerOff': 'PowerOff',
        'GuestShutdownFlag_Reboot': 'Reboot',
        'GuestShutdownFlag_Force': 'Force',
        ...
        'DirectoryCopyFlag_Recursive': 'Recursive',
        'DirectoryCopyFlag_FollowLinks': 'FollowLinks',
        ...
        'DirectoryStatus_Undefined': 'Undefined',
        'DirectoryStatus_Open': 'Open',
        'DirectoryStatus_Close': 'Close',
        'DirectoryStatus_Rewind': 'Rewind',
        'DirectoryStatus_Down': 'Down',
        'DirectoryStatus_Error': 'Error',
        ...
        'DirectoryOpenFlag_DenyAscent': 'DenyAscent',
        'DirectoryOpenFlag_NoFollowSymlinks': 'NoFollowSymlinks',
        ...
        'NetworkAttachmentType_HostOnlyNetwork': 'HostOnlyNetwork',
        ...
        'NetworkAdapterType_NE2000': 'NE2000',
        'NetworkAdapterType_NE1000': 'NE1000',
        'NetworkAdapterType_WD8013': 'WD8013',
        'NetworkAdapterType_WD8003': 'WD8003',
        ...
        'AudioDriverType_Default': 'Default',
        ...
        'AudioControllerType_VirtioSound': 'VirtioSound',
        ...
        'AudioDirection_Unknown': 'Unknown',
        'AudioDirection_In': 'In',
        'AudioDirection_Out': 'Out',
        'AudioDirection_Duplex': 'Duplex',
        'AudioDeviceType_Unknown': 'Unknown',
        'AudioDeviceType_BuiltLin': 'BuiltLin',
        'AudioDeviceType_ExternalUSB': 'ExternalUSB',
        'AudioDeviceType_ExternalOther': 'ExternalOther',
        'AudioDeviceState_Unknown': 'Unknown',
        'AudioDeviceState_Active': 'Active',
        'AudioDeviceState_Disabled': 'Disabled',
        'AudioDeviceState_NotPresent': 'NotPresent',
        'AudioDeviceState_Unplugged': 'Unplugged',
        'AuthType_Null': 'Null',
        ...
        'ChipsetType_ARMv8Virtual': 'ARMv8Virtual',
        ...
        'GuestDebugProvider_None': 'None',
        'GuestDebugProvider_Native': 'Native',
        'GuestDebugProvider_GDB': 'GDB',
        'GuestDebugProvider_KD': 'KD',
        'GuestDebugIoProvider_None': 'None',
        'GuestDebugIoProvider_TCP': 'TCP',
        'GuestDebugIoProvider_UDP': 'UDP',
        'GuestDebugIoProvider_IPC': 'IPC',
        ...
        'VBoxEventType_OnRecordingStateChanged': 'OnRecordingStateChanged',
        ...
        'VBoxEventType_OnCloudProviderListChanged': 'OnCloudProviderListChanged',
        'VBoxEventType_OnCloudProviderRegistered': 'OnCloudProviderRegistered',
        'VBoxEventType_OnCloudProviderUninstall': 'OnCloudProviderUninstall',
        'VBoxEventType_OnCloudProfileRegistered': 'OnCloudProfileRegistered',
        'VBoxEventType_OnCloudProfileChanged': 'OnCloudProfileChanged',
        'VBoxEventType_OnProgressCreated': 'OnProgressCreated',
        'VBoxEventType_OnLanguageChanged': 'OnLanguageChanged',
        'VBoxEventType_OnUpdateAgentAvailable': 'OnUpdateAgentAvailable',
        'VBoxEventType_OnUpdateAgentError': 'OnUpdateAgentError',
        'VBoxEventType_OnUpdateAgentSettingsChanged': 'OnUpdateAgentSettingsChanged',
        'VBoxEventType_OnUpdateAgentStateChanged': 'OnUpdateAgentStateChanged',
        'VBoxEventType_OnHostAudioDeviceChanged': 'OnHostAudioDeviceChanged',
        'VBoxEventType_OnGuestDebugControlChanged': 'OnGuestDebugControlChanged',
        'VBoxEventType_OnMachineGroupsChanged': 'OnMachineGroupsChanged',
        'VBoxEventType_OnGuestDirectoryRegistered': 'OnGuestDirectoryRegistered',
        'VBoxEventType_OnGuestDirectoryStateChanged': 'OnGuestDirectoryStateChanged',
        'VBoxEventType_OnGuestDirectoryRead': 'OnGuestDirectoryRead',
        'VBoxEventType_OnClipboardError': 'OnClipboardError',
        'VBoxEventType_OnExtPackInstalled': 'OnExtPackInstalled',
        'VBoxEventType_OnExtPackUninstalled': 'OnExtPackUninstalled',
        'VBoxEventType_OnRecordingScreenStateChanged': 'OnRecordingScreenStateChanged',
        'VBoxEventType_End': 'End',
        ...
        'MetricType_Invalid': 'Invalid',
        'MetricType_CpuUtilization': 'CpuUtilization',
        'MetricType_MemoryUtilization': 'MemoryUtilization',
        'MetricType_DiskBytesRead': 'DiskBytesRead',
        'MetricType_DiskBytesWritten': 'DiskBytesWritten',
        'MetricType_NetworksBytesIn': 'NetworksBytesIn',
        'MetricType_NetworksBytesOut': 'NetworksBytesOut',
        'SymlinkPolicy_None': 'None',
        'SymlinkPolicy_Forbidden': 'Forbidden',
        'SymlinkPolicy_AllowedInShareSubtree': 'AllowedInShareSubtree',
        'SymlinkPolicy_AllowedToRelativeTargets': 'AllowedToRelativeTargets',
        'SymlinkPolicy_AllowedToAnyTarget': 'AllowedToAnyTarget',
        # Result constants:
        ...
        'VBOX_E_PLATFORM_ARCH_NOT_SUPPORTED': 'VBOX_E_PLATFORM_ARCH_NOT_SUPPORTED',
        'VBOX_E_RECORDING_ERROR': 'VBOX_E_RECORDING_ERROR',
    }
