...
class vboxBindingSOAP:
    ...
    def IFramebuffer_getUsesGuestVRAM(self, request, **kw):
        ...
        self.binding.Send(None, None, request, soapaction="", **kw)
        # no output wsaction
        response = self.binding.Receive(IFramebuffer_getUsesGuestVRAMResultMsg.typecode)
        return response
    ...
    def IDisplay_setFramebuffer(self, request, **kw):
        ...
        self.binding.Send(None, None, request, soapaction="", **kw)
        # no output wsaction
        response = self.binding.Receive(IDisplay_setFramebufferResultMsg.typecode)
        return response
    ...
    def IDisplay_getFramebuffer(self, request, **kw):
        ...
        self.binding.Send(None, None, request, soapaction="", **kw)
        # no output wsaction
        response = self.binding.Receive(IDisplay_getFramebufferResultMsg.typecode)
        return response
