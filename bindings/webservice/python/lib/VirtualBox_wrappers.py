...
class IGuestSession(IUnknown):
   ...
   def processCreateEx(self, _arg_command, _arg_arguments, _arg_environment, _arg_flags, _arg_timeoutMS, _arg_priority, _arg_affinity):
...
class IGuest(IUnknown):
   ...
   def dragGHPending(self, _arg_screenId):
       ...
       return DragAndDropAction(self.mgr,val._returnval), String(self.mgr,val._formats, True), DragAndDropAction(self.mgr,val._allowedActions, True)
...
class IFramebuffer(IUnknown):
   ...
   def requestResize(self, _arg_screenId, _arg_pixelFormat, _arg_VRAM, _arg_bitsPerPixel, _arg_bytesPerLine, _arg_width, _arg_height):
...
class IDisplay(IUnknown):
   ...
   def getScreenResolution(self, _arg_screenId):
       ...
       return UnsignedInt(self.mgr,val._width), UnsignedInt(self.mgr,val._height), UnsignedInt(self.mgr,val._bitsPerPixel), Int(self.mgr,val._xOrigin), Int(self.mgr,val._yOrigin)
...
class SettingsVersion:
   ...
   _NameMap={0:'Null',1:'v1_0',2:'v1_1',3:'v1_2',4:'v1_3pre',5:'v1_3',6:'v1_4',7:'v1_5',8:'v1_6',9:'v1_7',10:'v1_8',11:'v1_9',12:'v1_10',13:'v1_11',14:'v1_12',15:'v1_13',16:'v1_14',99999:'Future'}
   _ValueMap={
              'Null':0,
              'v1_0':1,
              'v1_1':2,
...
class ProcessCreateFlag:
   ...
   _NameMap={0:'None',1:'WaitForProcessStartOnly',2:'IgnoreOrphanedProcesses',4:'Hidden',8:'NoProfile',16:'WaitForStdOut',32:'WaitForStdErr',64:'ExpandArguments'}
   _ValueMap={
              'None':0,
...
class FsObjType:
   ...
   _NameMap={0:'Undefined',1:'FIFO',10:'DevChar',11:'DevBlock',50:'Directory',80:'File',100:'Symlink',200:'Socket',400:'Whiteout'}
   _ValueMap={
              'Undefined':0,
              'FIFO':1,
              'DevChar':10,
...
class MediumVariant:
   ...
   _NameMap={0:'Standard',0x01:'VmdkSplit2G',0x02:'VmdkRawDisk',0x04:'VmdkStreamOptimized',0x08:'VmdkESX',0x10000:'Fixed',0x20000:'Diff',0x40000000:'NoCreateDir'}
   _ValueMap={
              'Standard':0,
              'VmdkSplit2G':0x01,
              'VmdkRawDisk':0x02,
