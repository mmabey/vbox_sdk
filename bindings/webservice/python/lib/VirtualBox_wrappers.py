...
class ManagedManager:
    ...
    def unregister(self, handle):
        ...
        if c == -1:
            raise Exception('wrong refcount')
        c = c - 1
        if c == 0:
            try:
...
class INATNetwork(IUnknown):
    ...
    def addPortForwardRule(self, _arg_isIpv6, _arg_ruleName, _arg_proto, _arg_hostIP, _arg_hostPort, _arg_guestIP,
                           _arg_guestPort):
    ...
    _Attrs_ = {'networkName': [getNetworkName, setNetworkName,
               ...
               'advertiseDefaultIPv6RouteEnabled': [getAdvertiseDefaultIPv6RouteEnabled,
...
class IVFSExplorer(IUnknown):
    ...
    def entryList(self):
        ...
        return String(self.mgr, val._names, True), UnsignedInt(self.mgr, val._types, True), Long(self.mgr, val._sizes,
                                                                                                 True), UnsignedInt(
            self.mgr, val._modes, True)
...
class IVirtualSystemDescription(IUnknown):
    ...
    def getDescription(self):
        ...
        return VirtualSystemDescriptionType(self.mgr, val._types, True), String(self.mgr, val._refs, True), String(
            self.mgr, val._OVFValues, True), String(self.mgr, val._VBoxValues, True), String(self.mgr,
                                                                                             val._extraConfigValues,
                                                                                             True)
...
class IMachine(IUnknown):
    ...
    def getCPUIDLeaf(self, _arg_id):
        ...
        return UnsignedInt(self.mgr, val._valEax), UnsignedInt(self.mgr, val._valEbx), UnsignedInt(self.mgr,
                                                                                                   val._valEcx), UnsignedInt(
            self.mgr, val._valEdx)
    ...
    def enumerateGuestProperties(self, _arg_patterns):
        ...
        return String(self.mgr, val._names, True), String(self.mgr, val._values, True), Long(self.mgr, val._timestamps,
                                                                                             True), String(self.mgr,
                                                                                                           val._flags,
                                                                                                           True)
    ...
    def querySavedGuestScreenInfo(self, _arg_screenId):
        ...
        return UnsignedInt(self.mgr, val._originX), UnsignedInt(self.mgr, val._originY), UnsignedInt(self.mgr,
                                                                                                     val._width), UnsignedInt(
            self.mgr, val._height), Boolean(self.mgr, val._enabled)
    ...
    def readSavedThumbnailToArray(self, _arg_screenId, _arg_BGR):
        ...
        return self.mgr.decodebase64(val._returnval), UnsignedInt(self.mgr, val._width), UnsignedInt(self.mgr,
                                                                                                     val._height)
    ...
    def getDragAndDropMode(self):
        req = IMachine_getDragAndDropModeRequestMsg()
        req._this = self.handle
        val = self.mgr.getPort().IMachine_getDragAndDropMode(req)
        return DragAndDropMode(self.mgr, val._returnval)
    ...
    def setDragAndDropMode(self, value):
        ...
        self.mgr.getPort().IMachine_setDragAndDropMode(req)
    ...
    _Attrs_ = {'parent': [getParent, None],
               ...
               'dragAndDropMode': [getDragAndDropMode, setDragAndDropMode,
                                   ],
               'guestPropertyNotificationPatterns': [getGuestPropertyNotificationPatterns,
...
class IGuestSession(IUnknown):
    ...
    def copyFrom(self, _arg_source, _arg_dest, _arg_flags):
        req = IGuestSession_copyFromRequestMsg()
        req._this = self.handle

        req._source = _arg_source
        req._dest = _arg_dest
        req._flags = _arg_flags
        val = self.mgr.getPort().IGuestSession_copyFrom(req)

        return IProgress(self.mgr, val._returnval)


    def copyTo(self, _arg_source, _arg_dest, _arg_flags):
        req = IGuestSession_copyToRequestMsg()
        req._this = self.handle

        req._source = _arg_source
        req._dest = _arg_dest
        req._flags = _arg_flags
        val = self.mgr.getPort().IGuestSession_copyTo(req)
    ...
    def directoryExists(self, _arg_path):
    ...
    def directoryQueryInfo(self, _arg_path):
        req = IGuestSession_directoryQueryInfoRequestMsg()
        req._this = self.handle

        req._path = _arg_path
        val = self.mgr.getPort().IGuestSession_directoryQueryInfo(req)
    ...
    def directoryRename(self, _arg_source, _arg_dest, _arg_flags):
        req = IGuestSession_directoryRenameRequestMsg()
        req._this = self.handle

        req._source = _arg_source
        req._dest = _arg_dest
        req._flags = _arg_flags
        val = self.mgr.getPort().IGuestSession_directoryRename(req)

        return


    def directorySetACL(self, _arg_path, _arg_acl):
        req = IGuestSession_directorySetACLRequestMsg()
        req._this = self.handle

        req._path = _arg_path
        req._acl = _arg_acl
        val = self.mgr.getPort().IGuestSession_directorySetACL(req)

        return


    def environmentClear(self):
        req = IGuestSession_environmentClearRequestMsg()
        req._this = self.handle

        val = self.mgr.getPort().IGuestSession_environmentClear(req)

        return


    def environmentGet(self, _arg_name):
        req = IGuestSession_environmentGetRequestMsg()
        req._this = self.handle

        req._name = _arg_name
        val = self.mgr.getPort().IGuestSession_environmentGet(req)

        return String(self.mgr, val._returnval)


    def environmentSet(self, _arg_name, _arg_value):
        req = IGuestSession_environmentSetRequestMsg()
        req._this = self.handle

        req._name = _arg_name
        req._value = _arg_value
        val = self.mgr.getPort().IGuestSession_environmentSet(req)

        return


    def environmentUnset(self, _arg_name):
        req = IGuestSession_environmentUnsetRequestMsg()
        req._this = self.handle

        req._name = _arg_name
        val = self.mgr.getPort().IGuestSession_environmentUnset(req)
    ...
    def fileRemove(self, _arg_path):
        req = IGuestSession_fileRemoveRequestMsg()
        req._this = self.handle

        req._path = _arg_path
        val = self.mgr.getPort().IGuestSession_fileRemove(req)

        return


    def fileOpen(self, _arg_path, _arg_openMode, _arg_disposition, _arg_creationMode):
        req = IGuestSession_fileOpenRequestMsg()
        req._this = self.handle

        req._path = _arg_path
        req._openMode = _arg_openMode
        req._disposition = _arg_disposition
    ...
    def fileOpenEx(self, _arg_path, _arg_openMode, _arg_disposition, _arg_sharingMode, _arg_creationMode, _arg_offset):
    ...
    def fileQueryInfo(self, _arg_path):
        req = IGuestSession_fileQueryInfoRequestMsg()
        req._this = self.handle

        req._path = _arg_path
        val = self.mgr.getPort().IGuestSession_fileQueryInfo(req)

        return IGuestFsObjInfo(self.mgr, val._returnval)


    def fileQuerySize(self, _arg_path):
    ...
    def fileRename(self, _arg_source, _arg_dest, _arg_flags):
        req = IGuestSession_fileRenameRequestMsg()
        req._this = self.handle

        req._source = _arg_source
        req._dest = _arg_dest
        req._flags = _arg_flags
        val = self.mgr.getPort().IGuestSession_fileRename(req)

        return


    def fileSetACL(self, _arg_file, _arg_acl):
        req = IGuestSession_fileSetACLRequestMsg()
        req._this = self.handle

        req._file = _arg_file
        req._acl = _arg_acl
        val = self.mgr.getPort().IGuestSession_fileSetACL(req)

        return


    def processCreate(self, _arg_command, _arg_arguments, _arg_environment, _arg_flags, _arg_timeoutMS):
    ...
    def processCreateEx(self, _arg_command, _arg_arguments, _arg_environment, _arg_flags, _arg_timeoutMS, _arg_priority,
                        _arg_affinity):
    ...
    def symlinkCreate(self, _arg_source, _arg_target, _arg_type):
    ...
    def symlinkRemoveDirectory(self, _arg_path):
        req = IGuestSession_symlinkRemoveDirectoryRequestMsg()
        req._this = self.handle

        req._path = _arg_path
        val = self.mgr.getPort().IGuestSession_symlinkRemoveDirectory(req)

        return


    def symlinkRemoveFile(self, _arg_file):
        req = IGuestSession_symlinkRemoveFileRequestMsg()
        req._this = self.handle

        req._file = _arg_file
        val = self.mgr.getPort().IGuestSession_symlinkRemoveFile(req)
    ...
    def getEnvironment(self):
        req = IGuestSession_getEnvironmentRequestMsg()
        req._this = self.handle
        val = self.mgr.getPort().IGuestSession_getEnvironment(req)
        return String(self.mgr, val._returnval, True)
    ...
    def setEnvironment(self, value):
        ...
        self.mgr.getPort().IGuestSession_setEnvironment(req)
    ...
    _Attrs_ = {'user': [getUser, None],
               ...
               'status': [getStatus, None],
               'environment': [getEnvironment, setEnvironment,
                               ],
...
class IFile(IUnknown):
    ...
    def getDisposition(self):
        req = IFile_getDispositionRequestMsg()
        req._this = self.handle
        val = self.mgr.getPort().IFile_getDisposition(req)
        return String(self.mgr, val._returnval)
    ...
    def getOpenMode(self):
        req = IFile_getOpenModeRequestMsg()
        req._this = self.handle
        val = self.mgr.getPort().IFile_getOpenMode(req)
        return String(self.mgr, val._returnval)
    ...
    _Attrs_ = {'creationMode': [getCreationMode, None],
               'disposition': [getDisposition, None],
               'eventSource': [getEventSource, None],
               'fileName': [getFileName, None],
               'id': [getId, None],
               'initialSize': [getInitialSize, None],
               'openMode': [getOpenMode, None],
...
class IGuest(IUnknown):
    ...
    def internalGetStatistics(self):
        ...
        return UnsignedInt(self.mgr, val._cpuUser), UnsignedInt(self.mgr, val._cpuKernel), UnsignedInt(self.mgr,
                                                                                                       val._cpuIdle), UnsignedInt(
            self.mgr, val._memTotal), UnsignedInt(self.mgr, val._memFree), UnsignedInt(self.mgr,
                                                                                       val._memBalloon), UnsignedInt(
            self.mgr, val._memShared), UnsignedInt(self.mgr, val._memCache), UnsignedInt(self.mgr,
                                                                                         val._pagedTotal), UnsignedInt(
            self.mgr, val._memAllocTotal), UnsignedInt(self.mgr, val._memFreeTotal), UnsignedInt(self.mgr,
                                                                                                 val._memBalloonTotal), UnsignedInt(
            self.mgr, val._memSharedTotal)
    ...
    def dragHGEnter(self, _arg_screenId, _arg_y, _arg_x, _arg_defaultAction, _arg_allowedActions, _arg_formats):
        req = IGuest_dragHGEnterRequestMsg()
        req._this = self.handle
        ...
        val = self.mgr.getPort().IGuest_dragHGEnter(req)

        return DragAndDropAction(self.mgr, val._returnval)


    def dragHGMove(self, _arg_screenId, _arg_x, _arg_y, _arg_defaultAction, _arg_allowedActions, _arg_formats):
        req = IGuest_dragHGMoveRequestMsg()
        req._this = self.handle
        ...
        req._allowedActions = _arg_allowedActions
        req._formats = _arg_formats
        val = self.mgr.getPort().IGuest_dragHGMove(req)

        return DragAndDropAction(self.mgr, val._returnval)


    def dragHGLeave(self, _arg_screenId):
        req = IGuest_dragHGLeaveRequestMsg()
        req._this = self.handle

        req._screenId = _arg_screenId
        val = self.mgr.getPort().IGuest_dragHGLeave(req)

        return


    def dragHGDrop(self, _arg_screenId, _arg_x, _arg_y, _arg_defaultAction, _arg_allowedActions, _arg_formats):
        req = IGuest_dragHGDropRequestMsg()
        req._this = self.handle
        ...
        req._allowedActions = _arg_allowedActions
        req._formats = _arg_formats
        val = self.mgr.getPort().IGuest_dragHGDrop(req)

        return DragAndDropAction(self.mgr, val._returnval), String(self.mgr, val._format)


    def dragHGPutData(self, _arg_screenId, _arg_format, _arg_data):
        req = IGuest_dragHGPutDataRequestMsg()
        req._this = self.handle

        req._screenId = _arg_screenId
        req._format = _arg_format
        req._data = self.mgr.encodebase64(_arg_data)
        val = self.mgr.getPort().IGuest_dragHGPutData(req)

        return IProgress(self.mgr, val._returnval)


    def dragGHPending(self, _arg_screenId):
        req = IGuest_dragGHPendingRequestMsg()
        req._this = self.handle

        req._screenId = _arg_screenId
        val = self.mgr.getPort().IGuest_dragGHPending(req)

        return DragAndDropAction(self.mgr, val._returnval), String(self.mgr, val._formats, True), DragAndDropAction(
            self.mgr, val._allowedActions, True)


    def dragGHDropped(self, _arg_format, _arg_action):
        req = IGuest_dragGHDroppedRequestMsg()
        req._this = self.handle

        req._format = _arg_format
        req._action = _arg_action
        val = self.mgr.getPort().IGuest_dragGHDropped(req)

        return IProgress(self.mgr, val._returnval)


    def dragGHGetData(self):
        req = IGuest_dragGHGetDataRequestMsg()
        req._this = self.handle

        val = self.mgr.getPort().IGuest_dragGHGetData(req)
...
class IMediumFormat(IUnknown):
    ...
    def describeProperties(self):
        ...
        return String(self.mgr, val._names, True), String(self.mgr, val._descriptions, True), DataType(self.mgr,
                                                                                                       val._types,
                                                                                                       True), UnsignedInt(
            self.mgr, val._flags, True), String(self.mgr, val._defaults, True)
...
class IFramebuffer(IUnknown):
    ...
    def lock(self):
        req = IFramebuffer_lockRequestMsg()
        req._this = self.handle

        val = self.mgr.getPort().IFramebuffer_lock(req)

        return


    def unlock(self):
        req = IFramebuffer_unlockRequestMsg()
        req._this = self.handle

        val = self.mgr.getPort().IFramebuffer_unlock(req)
    ...
    def requestResize(self, _arg_screenId, _arg_pixelFormat, _arg_VRAM, _arg_bitsPerPixel, _arg_bytesPerLine,
                      _arg_width, _arg_height):
        req = IFramebuffer_requestResizeRequestMsg()
        req._this = self.handle

        req._screenId = _arg_screenId
        req._pixelFormat = _arg_pixelFormat
        req._VRAM = _arg_VRAM
        req._bitsPerPixel = _arg_bitsPerPixel
        req._bytesPerLine = _arg_bytesPerLine
        req._width = _arg_width
        req._height = _arg_height
        val = self.mgr.getPort().IFramebuffer_requestResize(req)
    ...
    def getAddress(self):
        req = IFramebuffer_getAddressRequestMsg()
        req._this = self.handle
        val = self.mgr.getPort().IFramebuffer_getAddress(req)
        return Octet(self.mgr, val._returnval)
    ...
    def getUsesGuestVRAM(self):
        req = IFramebuffer_getUsesGuestVRAMRequestMsg()
        req._this = self.handle
        val = self.mgr.getPort().IFramebuffer_getUsesGuestVRAM(req)
        return Boolean(self.mgr, val._returnval)
...
class IDisplay(IUnknown):
    ...
    def getScreenResolution(self, _arg_screenId):
        ...
        return UnsignedInt(self.mgr, val._width), UnsignedInt(self.mgr, val._height), UnsignedInt(self.mgr,
                                                                                                  val._bitsPerPixel), Int(
            self.mgr, val._xOrigin), Int(self.mgr, val._yOrigin)
    ...
    def setVideoModeHint(self, _arg_display, _arg_enabled, _arg_changeOrigin, _arg_originX, _arg_originY, _arg_width,
...
class IPerformanceCollector(IUnknown):
    ...
    def queryMetricsData(self, _arg_metricNames, _arg_objects):
        ...
        return Int(self.mgr, val._returnval, True), String(self.mgr, val._returnMetricNames, True), IUnknown(self.mgr,
                                                                                                             val._returnObjects,
                                                                                                             True), String(
            self.mgr, val._returnUnits, True), UnsignedInt(self.mgr, val._returnScales, True), UnsignedInt(self.mgr,
                                                                                                           val._returnSequenceNumbers,
                                                                                                           True), UnsignedInt(
            self.mgr, val._returnDataIndices, True), UnsignedInt(self.mgr, val._returnDataLengths, True)
...
class INATEngine(IUnknown):
    ...
    def getNetworkSettings(self):
        ...
        return UnsignedInt(self.mgr, val._mtu), UnsignedInt(self.mgr, val._sockSnd), UnsignedInt(self.mgr,
                                                                                                 val._sockRcv), UnsignedInt(
            self.mgr, val._TcpWndSnd), UnsignedInt(self.mgr, val._TcpWndRcv)
...
class IDragAndDropModeChangedEvent(IEvent):
    ...
    def __getattr__(self, name):
        hndl = IDragAndDropModeChangedEvent._Attrs_.get(name, None)
        if hndl != None:
            if hndl[0] != None:
                return hndl[0](self)
            else:
    ...
    def getDragAndDropMode(self):
        req = IDragAndDropModeChangedEvent_getDragAndDropModeRequestMsg()
        req._this = self.handle
        val = self.mgr.getPort().IDragAndDropModeChangedEvent_getDragAndDropMode(req)
        return DragAndDropMode(self.mgr, val._returnval)


    _Attrs_ = {'dragAndDropMode': [getDragAndDropMode, None]}
...
class IPCIDeviceAttachment:
    ...
    def setName(self):
        raise Exception('setters not supported')
...
class IGuestOSType:
    def __init__(self, mgr, handle, isarray=False):
        ...
        if isarray:
            ...
            self.recommendedDVDStorageController = StorageControllerType(self.mgr,
                                                                         handle._recommendedDVDStorageController)

            self.recommendedDVDStorageBus = StorageBus(self.mgr, handle._recommendedDVDStorageBus)

            self.recommendedHDStorageController = StorageControllerType(self.mgr,
                                                                        handle._recommendedHDStorageController)
...
class SettingsVersion:
    ...
    _NameMap = {0: 'Null', 1: 'v1_0', 2: 'v1_1', 3: 'v1_2', 4: 'v1_3pre', 5: 'v1_3', 6: 'v1_4', 7: 'v1_5', 8: 'v1_6',
                9: 'v1_7', 10: 'v1_8', 11: 'v1_9', 12: 'v1_10', 13: 'v1_11', 14: 'v1_12', 15: 'v1_13', 16: 'v1_14',
                99999: 'Future'}
    _ValueMap = {
        'Null': 0,
        'v1_0': 1,
...
class MachineState:
    ...
    _NameMap = {0: 'Null', 1: 'PoweredOff', 2: 'Saved', 3: 'Teleported', 4: 'Aborted', 5: 'Running', 6: 'Paused',
                ...
                20: 'DeletingSnapshot', 21: 'SettingUp', 5: 'FirstOnline', 18: 'LastOnline', 8: 'FirstTransient',
                21: 'LastTransient'}
    _ValueMap = {
        'Null': 0,
        'PoweredOff': 1,
...
class CPUPropertyType:
    ...
    _NameMap = {0: 'Null', 1: 'PAE', 2: 'Synthetic', 3: 'LongMode', 4: 'TripleFaultReset'}
    _ValueMap = {
        'Null': 0,
        'PAE': 1,
        'Synthetic': 2,
...
class HWVirtExPropertyType:
    ...
    _NameMap = {0: 'Null', 1: 'Enabled', 2: 'VPID', 3: 'NestedPaging', 4: 'UnrestrictedExecution', 5: 'LargePages',
                6: 'Force'}
    _ValueMap = {
        'Null': 0,
        'Enabled': 1,
...
class LockType:
    ...
    _NameMap = {2: 'Write', 1: 'Shared', 3: 'VM'}
    _ValueMap = {
        'Write': 2,
        'Shared': 1,
        'VM': 3}
...
class DragAndDropMode:
    ...
    def __eq__(self, other):
        if isinstance(other, DragAndDropMode):
            return self.handle == other.handle
        if isinstance(other, int):
            return self.handle == other
        if isinstance(other, basestring):
    ...
    def __str__(self):
        return DragAndDropMode._NameMap[self.handle]
...
class DhcpOpt:
    ...
    _NameMap = {1: 'SubnetMask', 2: 'TimeOffset', 3: 'Router', 4: 'TimeServer', 5: 'NameServer', 6: 'DomainNameServer',
                7: 'LogServer', 8: 'Cookie', 9: 'LPRServer', 10: 'ImpressServer', 11: 'ResourseLocationServer',
                12: 'HostName', 13: 'BootFileSize', 14: 'MeritDumpFile', 15: 'DomainName', 16: 'SwapServer',
                17: 'RootPath', 18: 'ExtensionPath', 19: 'IPForwardingEnableDisable',
                20: 'NonLocalSourceRoutingEnableDisable', 21: 'PolicyFilter', 22: 'MaximumDatagramReassemblySize',
                23: 'DefaultIPTime2Live', 24: 'PathMTUAgingTimeout', 25: 'IPLayerParametersPerInterface',
                26: 'InterfaceMTU', 27: 'AllSubnetsAreLocal', 28: 'BroadcastAddress', 29: 'PerformMaskDiscovery',
                30: 'MaskSupplier', 31: 'PerformRouteDiscovery', 32: 'RouterSolicitationAddress', 33: 'StaticRoute',
                34: 'TrailerEncapsulation', 35: 'ARPCacheTimeout', 36: 'EthernetEncapsulation', 37: 'TCPDefaultTTL',
                38: 'TCPKeepAliveInterval', 39: 'TCPKeepAliveGarbage', 40: 'NetworkInformationServiceDomain',
                41: 'NetworkInformationServiceServers', 42: 'NetworkTimeProtocolServers',
                43: 'VendorSpecificInformation', 44: 'Option_44', 45: 'Option_45', 46: 'Option_46', 47: 'Option_47',
                48: 'Option_48', 49: 'Option_49', 51: 'IPAddressLeaseTime', 64: 'Option_64', 65: 'Option_65',
                66: 'TFTPServerName', 67: 'BootfileName', 68: 'Option_68', 69: 'Option_69', 70: 'Option_70',
                71: 'Option_71', 72: 'Option_72', 73: 'Option_73', 74: 'Option_74', 75: 'Option_75', 119: 'Option_119'}
    _ValueMap = {
        'SubnetMask': 1,
        'TimeOffset': 2,
        'Router': 3,
...
class VFSFileType:
    ...
    _NameMap = {1: 'Unknown', 2: 'Fifo', 3: 'DevChar', 4: 'Directory', 5: 'DevBlock', 6: 'File', 7: 'SymLink',
                8: 'Socket', 9: 'WhiteOut'}
    _ValueMap = {
        'Unknown': 1,
        'Fifo': 2,
...
class VirtualSystemDescriptionType:
    ...
    _NameMap = {1: 'Ignore', 2: 'OS', 3: 'Name', 4: 'Product', 5: 'Vendor', 6: 'Version', 7: 'ProductUrl',
                8: 'VendorUrl', 9: 'Description', 10: 'License', 11: 'Miscellaneous', 12: 'CPU', 13: 'Memory',
                14: 'HardDiskControllerIDE', 15: 'HardDiskControllerSATA', 16: 'HardDiskControllerSCSI',
                17: 'HardDiskControllerSAS', 18: 'HardDiskImage', 19: 'Floppy', 20: 'CDROM', 21: 'NetworkAdapter',
...
class AdditionsFacilityType:
    ...
    _NameMap = {0: 'None', 20: 'VBoxGuestDriver', 90: 'AutoLogon', 100: 'VBoxService', 101: 'VBoxTrayClient',
                1000: 'Seamless', 1100: 'Graphics', 2147483646: 'All'}
    _ValueMap = {
        'None': 0,
        'VBoxGuestDriver': 20,
        'AutoLogon': 90,
...
class AdditionsFacilityClass:
    ...
    _NameMap = {0: 'None', 10: 'Driver', 30: 'Service', 50: 'Program', 100: 'Feature', 999: 'ThirdParty',
                2147483646: 'All'}
    _ValueMap = {
        'None': 0,
        'Driver': 10,
...
class AdditionsFacilityStatus:
    ...
    _NameMap = {0: 'Inactive', 1: 'Paused', 20: 'PreInit', 30: 'Init', 50: 'Active', 100: 'Terminating',
                101: 'Terminated', 800: 'Failed', 999: 'Unknown'}
    _ValueMap = {
        'Inactive': 0,
        'Paused': 1,
        'PreInit': 20,
...
class GuestSessionStatus:
    ...
    _NameMap = {0: 'Undefined', 10: 'Starting', 100: 'Started', 480: 'Terminating', 500: 'Terminated',
                512: 'TimedOutKilled', 513: 'TimedOutAbnormally', 600: 'Down', 800: 'Error'}
    _ValueMap = {
        'Undefined': 0,
        'Starting': 10,
        'Started': 100,
...
class GuestUserState:
    ...
    _NameMap = {0: 'Unknown', 1: 'LoggedIn', 2: 'LoggedOut', 3: 'Locked', 4: 'Unlocked', 5: 'Disabled', 6: 'Idle',
                7: 'InUse', 8: 'Created', 9: 'Deleted', 10: 'SessionChanged', 11: 'CredentialsChanged',
                12: 'RoleChanged', 13: 'GroupAdded', 14: 'GroupRemoved', 15: 'Elevated'}
    _ValueMap = {
        'Unknown': 0,
        'LoggedIn': 1,
        'LoggedOut': 2,
...
class FileSeekType:
    ...
    def __eq__(self, other):
        if isinstance(other, FileSeekType):
            return self.handle == other.handle
        if isinstance(other, int):
            return self.handle == other
        if isinstance(other, basestring):
    ...
    def __str__(self):
        return FileSeekType._NameMap[self.handle]

    def __int__(self):
        return self.handle

    _NameMap = {0: 'Set', 1: 'Current'}
    _ValueMap = {
        'Set': 0,
        'Current': 1}
...
class ProcessWaitResult:
    ...
    _NameMap = {0: 'None', 1: 'Start', 2: 'Terminate', 3: 'Status', 4: 'Error', 5: 'Timeout', 6: 'StdIn', 7: 'StdOut',
                8: 'StdErr', 9: 'WaitFlagNotSupported'}
    _ValueMap = {
        'None': 0,
        'Start': 1,
        'Terminate': 2,
...
class PathRenameFlag:
    ...
    def __eq__(self, other):
        if isinstance(other, PathRenameFlag):
            return self.handle == other.handle
        if isinstance(other, int):
            return self.handle == other
        if isinstance(other, basestring):
    ...
    def __str__(self):
        return PathRenameFlag._NameMap[self.handle]

    def __int__(self):
        return self.handle

    _NameMap = {0: 'None', 1: 'NoReplace', 2: 'Replace', 4: 'NoSymlinks'}
    _ValueMap = {
        'None': 0,
        'NoReplace': 1,
        'Replace': 2,
...
class ProcessCreateFlag:
    ...
    _NameMap = {0: 'None', 1: 'WaitForProcessStartOnly', 2: 'IgnoreOrphanedProcesses', 4: 'Hidden', 8: 'NoProfile',
                16: 'WaitForStdOut', 32: 'WaitForStdErr', 64: 'ExpandArguments'}
    _ValueMap = {
        'None': 0,
...
class ProcessStatus:
    ...
    _NameMap = {0: 'Undefined', 10: 'Starting', 100: 'Started', 110: 'Paused', 480: 'Terminating',
                500: 'TerminatedNormally', 510: 'TerminatedSignal', 511: 'TerminatedAbnormally', 512: 'TimedOutKilled',
                513: 'TimedOutAbnormally', 600: 'Down', 800: 'Error'}
    _ValueMap = {
        'Undefined': 0,
        'Starting': 10,
        'Started': 100,
...
class FsObjType:
    ...
    _NameMap = {0: 'Undefined', 1: 'FIFO', 10: 'DevChar', 11: 'DevBlock', 50: 'Directory', 80: 'File', 100: 'Symlink',
                200: 'Socket', 400: 'Whiteout'}
    _ValueMap = {
        'Undefined': 0,
        'FIFO': 1,
        'DevChar': 10,
...
class DragAndDropAction:
    ...
    def __eq__(self, other):
        if isinstance(other, DragAndDropAction):
            return self.handle == other.handle
        if isinstance(other, int):
            return self.handle == other
        if isinstance(other, basestring):
    ...
    def __str__(self):
        return DragAndDropAction._NameMap[self.handle]
...
class MediumState:
    ...
    _NameMap = {0: 'NotCreated', 1: 'Created', 2: 'LockedRead', 3: 'LockedWrite', 4: 'Inaccessible', 5: 'Creating',
                6: 'Deleting'}
    _ValueMap = {
        'NotCreated': 0,
        'Created': 1,
...
class MediumVariant:
    ...
    _NameMap = {0: 'Standard', 0x01: 'VmdkSplit2G', 0x02: 'VmdkRawDisk', 0x04: 'VmdkStreamOptimized', 0x08: 'VmdkESX',
                0x10000: 'Fixed', 0x20000: 'Diff', 0x40000000: 'NoCreateDir'}
    _ValueMap = {
        'Standard': 0,
        'VmdkSplit2G': 0x01,
        'VmdkRawDisk': 0x02,
...
class MediumFormatCapabilities:
    ...
    _NameMap = {0x01: 'Uuid', 0x02: 'CreateFixed', 0x04: 'CreateDynamic', 0x08: 'CreateSplit2G', 0x10: 'Differencing',
                0x20: 'Asynchronous', 0x40: 'File', 0x80: 'Properties', 0x100: 'TcpNetworking', 0x200: 'VFS',
...
class MouseButtonState:
    ...
    _NameMap = {0x01: 'LeftButton', 0x02: 'RightButton', 0x04: 'MiddleButton', 0x08: 'WheelUp', 0x10: 'WheelDown',
                0x20: 'XButton1', 0x40: 'XButton2', 0x7F: 'MouseStateMask'}
    _ValueMap = {
        'LeftButton': 0x01,
        'RightButton': 0x02,
        'MiddleButton': 0x04,
...
class USBControllerType:
    ...
    _NameMap = {0: 'Null', 1: 'OHCI', 2: 'EHCI', 3: 'Last'}
    _ValueMap = {
        'Null': 0,
        'OHCI': 1,
        'EHCI': 2,
...
class AudioDriverType:
    ...
    _NameMap = {0: 'Null', 1: 'WinMM', 2: 'OSS', 3: 'ALSA', 4: 'DirectSound', 5: 'CoreAudio', 6: 'MMPM', 7: 'Pulse',
                8: 'SolAudio'}
    _ValueMap = {
        'Null': 0,
        'WinMM': 1,
...
class Reason:
    ...
    _NameMap = {0: 'Unspecified', 1: 'HostSuspend', 2: 'HostResume', 3: 'HostBatteryLow'}
    _ValueMap = {
        'Unspecified': 0,
        'HostSuspend': 1,
        'HostResume': 2,
...
class StorageControllerType:
    ...
    _NameMap = {0: 'Null', 1: 'LsiLogic', 2: 'BusLogic', 3: 'IntelAhci', 4: 'PIIX3', 5: 'PIIX4', 6: 'ICH6', 7: 'I82078',
                8: 'LsiLogicSas'}
    _ValueMap = {
        'Null': 0,
        'LsiLogic': 1,
...
class VBoxEventType:
    ...
    _NameMap = {0: 'Invalid', 1: 'Any', 2: 'Vetoable', 3: 'MachineEvent', 4: 'SnapshotEvent', 5: 'InputEvent',
                31: 'LastWildcard', 32: 'OnMachineStateChanged', 33: 'OnMachineDataChanged', 34: 'OnExtraDataChanged',
                35: 'OnExtraDataCanChange', 36: 'OnMediumRegistered', 37: 'OnMachineRegistered',
                38: 'OnSessionStateChanged', 39: 'OnSnapshotTaken', 40: 'OnSnapshotDeleted', 41: 'OnSnapshotChanged',
                42: 'OnGuestPropertyChanged', 43: 'OnMousePointerShapeChanged', 44: 'OnMouseCapabilityChanged',
                45: 'OnKeyboardLedsChanged', 46: 'OnStateChanged', 47: 'OnAdditionsStateChanged',
                48: 'OnNetworkAdapterChanged', 49: 'OnSerialPortChanged', 50: 'OnParallelPortChanged',
                51: 'OnStorageControllerChanged', 52: 'OnMediumChanged', 53: 'OnVRDEServerChanged',
                54: 'OnUSBControllerChanged', 55: 'OnUSBDeviceStateChanged', 56: 'OnSharedFolderChanged',
                57: 'OnRuntimeError', 58: 'OnCanShowWindow', 59: 'OnShowWindow', 60: 'OnCPUChanged',
                61: 'OnVRDEServerInfoChanged', 62: 'OnEventSourceChanged', 63: 'OnCPUExecutionCapChanged',
                64: 'OnGuestKeyboard', 65: 'OnGuestMouse', 66: 'OnNATRedirect', 67: 'OnHostPCIDevicePlug',
                68: 'OnVBoxSVCAvailabilityChanged', 69: 'OnBandwidthGroupChanged', 70: 'OnGuestMonitorChanged',
                71: 'OnStorageDeviceChanged', 72: 'OnClipboardModeChanged', 73: 'OnDragAndDropModeChanged',
                74: 'OnNATNetworkChanged', 75: 'OnNATNetworkStartStop', 76: 'OnNATNetworkAlter',
                77: 'OnNATNetworkCreationDeletion', 78: 'OnNATNetworkSetting', 79: 'OnNATNetworkPortForward',
                80: 'OnGuestSessionStateChanged', 81: 'OnGuestSessionRegistered', 82: 'OnGuestProcessRegistered',
                83: 'OnGuestProcessStateChanged', 84: 'OnGuestProcessInputNotify', 85: 'OnGuestProcessOutput',
                86: 'OnGuestFileRegistered', 87: 'OnGuestFileStateChanged', 88: 'OnGuestFileOffsetChanged',
                89: 'OnGuestFileRead', 90: 'OnGuestFileWrite', 91: 'OnVideoCaptureChanged',
                92: 'OnGuestUserStateChanged', 93: 'OnGuestMultiTouch', 94: 'OnHostNameResolutionConfigurationChange',
                95: 'Last'}
    _ValueMap = {
        'Invalid': 0,
        'Any': 1,
