...
const nsID IID_IGraphicsAdapter = {
    0x13ee6eb4, 0x06fe, 0x406b, \
    { 0xad, 0x69, 0xf6, 0xe0, 0x8b, 0x05, 0x87, 0xa3 } \
};

const nsID IID_IFirmwareSettings = {
    0x426EF1B8, 0xDE91, 0x49FB, \
    { 0xAB, 0xC3, 0x0E, 0x2B, 0xAE, 0x65, 0x4F, 0xF2 } \
};

const nsID IID_ITrustedPlatformModule = {
...
const nsID IID_IUefiVariableStore = {
    0xd134c6b6, 0x4479, 0x430d, \
    { 0xbb, 0x73, 0x68, 0xa4, 0x52, 0xba, 0x3e, 0x67 } \
};

const nsID IID_INvramStore = {
    0x5bfd8965, 0xb81b, 0x469f, \
    { 0x86, 0x49, 0xf7, 0x17, 0xce, 0x97, 0xa5, 0xd5 } \
};

const nsID IID_IResourceStore = {
    0xd96a2540, 0x8aab, 0x4c71, \
    { 0x8a, 0xf9, 0x95, 0x37, 0x9f, 0x23, 0xb2, 0x3d } \
};

const nsID IID_IPlatform = {
    0xa670a023, 0xe172, 0x452c, \
    { 0xb7, 0x31, 0x14, 0xef, 0x85, 0x5f, 0x4d, 0xa6 } \
};

const nsID IID_IPlatformX86 = {
    0x5ada589f, 0x09c9, 0x4604, \
    { 0xb7, 0x00, 0x9a, 0xb3, 0xa5, 0x57, 0x2e, 0x3a } \
};

const nsID IID_IPlatformARM = {
    0x75dff9be, 0x6cb3, 0x4857, \
    { 0xbd, 0xe6, 0x2f, 0xaf, 0x82, 0xed, 0x9a, 0x8d } \
};

const nsID IID_IMachine = {
    0xe36a5081, 0xa82a, 0x40bd, \
    { 0x9e, 0x4e, 0x42, 0xa4, 0x4d, 0x6c, 0xe5, 0x0f } \
};
...
const nsID IID_IUpdateAgent = {
    0xc4b1b5f4, 0x8cdf, 0x4923, \
    { 0x9e, 0xf6, 0xb9, 0x24, 0x76, 0xa8, 0x41, 0x09 } \
};

const nsID IID_IHostUpdateAgent = {
    0xd782dba7, 0xcd4f, 0x4ace, \
    { 0x95, 0x1a, 0x58, 0x32, 0x1c, 0x23, 0xe2, 0x58 } \
};

const nsID IID_IHostDrivePartition = {
    0x4f529a14, 0xace3, 0x407c, \
    { 0x9c, 0x49, 0x06, 0x6e, 0x8e, 0x80, 0x27, 0xf0 } \
};

const nsID IID_IHostDrive = {
    0x70e2e0c3, 0x332c, 0x4d72, \
    { 0xb8, 0x22, 0x2d, 0xb1, 0x6e, 0x2c, 0xb3, 0x1b } \
};

const nsID IID_IHostX86 = {
    0x50c97996, 0x9cf8, 0x417f, \
    { 0xbd, 0x79, 0x1e, 0x04, 0x71, 0x36, 0x7c, 0xd3 } \
};

const nsID IID_IHost = {
    0xd5dcece0, 0xb202, 0x4416, \
    { 0xa1, 0x38, 0x03, 0x50, 0x27, 0x84, 0xcc, 0x07 } \
};

const nsID IID_ICPUProfile = {
    0xb7fda727, 0x7a08, 0x46ee, \
    { 0x8d, 0xd8, 0xf8, 0xd7, 0x30, 0x8b, 0x51, 0x9c } \
};

const nsID IID_IPlatformProperties = {
    0x5bae19d0, 0xca40, 0x4ca2, \
    { 0xa4, 0x85, 0xc8, 0x06, 0x51, 0x90, 0xbb, 0xe5 } \
};

const nsID IID_ISystemProperties = {
    0x925084b0, 0x625f, 0x422f, \
    { 0xa6, 0x7d, 0x0e, 0xde, 0x18, 0x80, 0xa5, 0x6c } \
};
...
const nsID IID_IGuestSession = {
    0x8b2b6773, 0x8b5a, 0x4cd2, \
    { 0x95, 0xf8, 0x38, 0xfa, 0xf7, 0x39, 0x13, 0xe1 } \
};
...
const nsID IID_IDirectory = {
    0xa508e094, 0xbf24, 0x4eca, \
    { 0x80, 0xc6, 0x46, 0x77, 0x66, 0xa1, 0xe4, 0xc0 } \
};
...
const nsID IID_IMedium = {
    0x7d510820, 0xa678, 0x4730, \
    { 0xa8, 0x62, 0x81, 0x8d, 0xcd, 0x3f, 0xbe, 0xd0 } \
};
...
const nsID IID_ISharedFolder = {
    0x0b108b8c, 0x62e0, 0x4e06, \
    { 0x9d, 0xfa, 0x2f, 0x1a, 0x2a, 0xd7, 0x07, 0x74 } \
};

const nsID IID_IInternalSessionControl = {
    0x739160a6, 0x53ea, 0x465b, \
    { 0xbb, 0x6b, 0x53, 0x26, 0xc2, 0x0a, 0x3c, 0x0c } \
};
...
const nsID IID_IGuestDebugControl = {
...
const nsID IID_IExtPackInstalledEvent = {
    0x29059fea, 0x2c99, 0x11ee, \
    { 0xbe, 0x56, 0x02, 0x42, 0xac, 0x12, 0x00, 0x02 } \
};

const nsID IID_IExtPackUninstalledEvent = {
    0x31aab263, 0x95ef, 0x48a4, \
    { 0x9c, 0xe7, 0xea, 0xf0, 0xd3, 0xae, 0x15, 0x0f } \
};
...
const nsID IID_IClipboardFileTransferModeChangedEvent = {
    0x00391758, 0x00B1, 0x4E9D, \
    { 0x00, 0x00, 0x11, 0xFA, 0x00, 0xF9, 0xD5, 0x83 } \
};

const nsID IID_IClipboardEvent = {
    0xf22dd3b4, 0xe4d0, 0x437a, \
    { 0xbf, 0xdf, 0x03, 0x72, 0x89, 0x6b, 0xa1, 0x62 } \
};

const nsID IID_IClipboardErrorEvent = {
    0x9e5f6f25, 0xbeda, 0x46ad, \
    { 0x8d, 0xdb, 0x23, 0xc0, 0x26, 0x8a, 0xc3, 0x45 } \
};
...
const nsID IID_IGuestDirectoryEvent = {
    0x02b69798, 0x7cc2, 0x4005, \
    { 0xac, 0x57, 0x1a, 0xd7, 0xff, 0x7a, 0x09, 0x97 } \
};

const nsID IID_IGuestDirectoryRegisteredEvent = {
    0x926baa39, 0xcfc9, 0x462e, \
    { 0xa1, 0xa1, 0xc4, 0x39, 0xe2, 0x8f, 0x7f, 0x89 } \
};

const nsID IID_IGuestDirectoryStateChangedEvent = {
    0xc32bce60, 0xd69d, 0x4eb7, \
    { 0xa0, 0x2a, 0x41, 0x1e, 0xcb, 0xab, 0x6a, 0x18 } \
};

const nsID IID_IGuestDirectoryReadEvent = {
    0x4e774bbe, 0x5285, 0x4517, \
    { 0x8d, 0x34, 0x21, 0x26, 0x06, 0x33, 0xc5, 0x13 } \
};
...
const nsID IID_IGuestFileSizeChangedEvent = {
...
const nsID IID_IRecordingStateChangedEvent = {
    0xe578bb9c, 0xe88d, 0x416b, \
    { 0xbb, 0x45, 0x08, 0xa4, 0xe7, 0xa5, 0xb4, 0x63 } \
};

const nsID IID_IRecordingScreenStateChangedEvent = {
    0x5900472f, 0xcc58, 0x48ac, \
    { 0xa0, 0x88, 0xb5, 0x71, 0xb7, 0x7f, 0x83, 0x9b } \
};
...
const nsID IID_IHostAudioDeviceChangedEvent = {
...
const nsID IID_IProgressCreatedEvent = {
