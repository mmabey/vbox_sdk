/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /mnt/tinderbox/7.1-sdk/src/libs/xpcom18a4/xpcom/ds/nsIObserverService.idl
 */
...
#define NS_FORWARD_NSIOBSERVERSERVICE(_to) \
  ...
  NS_IMETHOD EnumerateObservers(const char *aTopic, nsISimpleEnumerator * *_retval) { return _to EnumerateObservers(aTopic, nsISimpleEnumerator * *_retval); } 
...
#define NS_FORWARD_SAFE_NSIOBSERVERSERVICE(_to) \
  ...
  NS_IMETHOD EnumerateObservers(const char *aTopic, nsISimpleEnumerator * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->EnumerateObservers(aTopic, nsISimpleEnumerator * *_retval); } 
