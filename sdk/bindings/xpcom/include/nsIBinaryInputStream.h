/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /mnt/tinderbox/7.2-sdk/src/libs/xpcom18a4/xpcom/io/nsIBinaryInputStream.idl
 */
...
#define NS_FORWARD_NSIBINARYINPUTSTREAM(_to) \
  ...
  NS_IMETHOD ReadBoolean(PRBool *_retval) { return _to ReadBoolean(PRBool *_retval); } \
  NS_IMETHOD Read8(PRUint8 *_retval) { return _to Read8(PRUint8 *_retval); } \
  NS_IMETHOD Read16(PRUint16 *_retval) { return _to Read16(PRUint16 *_retval); } \
  NS_IMETHOD Read32(PRUint32 *_retval) { return _to Read32(PRUint32 *_retval); } \
  NS_IMETHOD Read64(PRUint64 *_retval) { return _to Read64(PRUint64 *_retval); } \
  NS_IMETHOD ReadFloat(float *_retval) { return _to ReadFloat(float *_retval); } \
  NS_IMETHOD ReadDouble(double *_retval) { return _to ReadDouble(double *_retval); } \
  NS_IMETHOD ReadCString(nsACString & _retval) { return _to ReadCString(nsACString & _retval); } \
  NS_IMETHOD ReadString(nsAString & _retval) { return _to ReadString(nsAString & _retval); } \
...
#define NS_FORWARD_SAFE_NSIBINARYINPUTSTREAM(_to) \
  ...
  NS_IMETHOD ReadBoolean(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ReadBoolean(PRBool *_retval); } \
  NS_IMETHOD Read8(PRUint8 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Read8(PRUint8 *_retval); } \
  NS_IMETHOD Read16(PRUint16 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Read16(PRUint16 *_retval); } \
  NS_IMETHOD Read32(PRUint32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Read32(PRUint32 *_retval); } \
  NS_IMETHOD Read64(PRUint64 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Read64(PRUint64 *_retval); } \
  NS_IMETHOD ReadFloat(float *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ReadFloat(float *_retval); } \
  NS_IMETHOD ReadDouble(double *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ReadDouble(double *_retval); } \
  NS_IMETHOD ReadCString(nsACString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ReadCString(nsACString & _retval); } \
  NS_IMETHOD ReadString(nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ReadString(nsAString & _retval); } \
