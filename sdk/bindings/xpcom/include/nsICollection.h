/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /mnt/tinderbox/7.1-sdk/src/libs/xpcom18a4/xpcom/ds/nsICollection.idl
 */
...
#define NS_FORWARD_NSICOLLECTION(_to) \
  NS_IMETHOD Count(PRUint32 *_retval) { return _to Count(PRUint32 *_retval); } \
  NS_IMETHOD GetElementAt(PRUint32 index, nsISupports * *_retval) { return _to GetElementAt(index, nsISupports * *_retval); } \
  ...
  NS_IMETHOD Enumerate(nsIEnumerator * *_retval) { return _to Enumerate(nsIEnumerator * *_retval); } \
  NS_IMETHOD Clear(void) { return _to Clear(); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICOLLECTION(_to) \
  NS_IMETHOD Count(PRUint32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Count(PRUint32 *_retval); } \
  NS_IMETHOD GetElementAt(PRUint32 index, nsISupports * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetElementAt(index, nsISupports * *_retval); } \
  ...
  NS_IMETHOD Enumerate(nsIEnumerator * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Enumerate(nsIEnumerator * *_retval); } \
