/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /mnt/tinderbox/7.2-sdk/src/libs/xpcom18a4/xpcom/ds/nsISupportsArray.idl
 */
...
#define NS_FORWARD_NSISUPPORTSARRAY(_to) \
  ...
  NS_IMETHOD GetIndexOf(nsISupports * aPossibleElement, PRInt32 *_retval) { return _to GetIndexOf(aPossibleElement, PRInt32 *_retval); } \
  NS_IMETHOD GetIndexOfStartingAt(nsISupports * aPossibleElement, PRUint32 aStartIndex, PRInt32 *_retval) { return _to GetIndexOfStartingAt(aPossibleElement, aStartIndex, PRInt32 *_retval); } \
  NS_IMETHOD GetLastIndexOf(nsISupports * aPossibleElement, PRInt32 *_retval) { return _to GetLastIndexOf(aPossibleElement, PRInt32 *_retval); } \
  ...
  NS_IMETHOD Clone(nsISupportsArray * *_retval) { return _to Clone(nsISupportsArray * *_retval); } \
...
#define NS_FORWARD_SAFE_NSISUPPORTSARRAY(_to) \
  ...
  NS_IMETHOD GetIndexOf(nsISupports * aPossibleElement, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIndexOf(aPossibleElement, PRInt32 *_retval); } \
  NS_IMETHOD GetIndexOfStartingAt(nsISupports * aPossibleElement, PRUint32 aStartIndex, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIndexOfStartingAt(aPossibleElement, aStartIndex, PRInt32 *_retval); } \
  NS_IMETHOD GetLastIndexOf(nsISupports * aPossibleElement, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLastIndexOf(aPossibleElement, PRInt32 *_retval); } \
  ...
  NS_IMETHOD Clone(nsISupportsArray * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Clone(nsISupportsArray * *_retval); } \
